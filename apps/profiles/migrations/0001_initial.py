# Generated by Django 3.2.7 on 2023-03-06 15:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(default='+4878409855', max_length=30, region=None, verbose_name='Phone Number')),
                ...
                ('city', models.CharField(default='Warsaw', max_length=180, verbose_name='City')),
                ('is_buyer', models.BooleanField(default=False, help_text='Do you want to buy a property?', verbose_name='Buyer')),
                ('is_seller', models.BooleanField(default=False, help_text='Do you want to sell a property?', verbose_name='Seller')),
                ('is_agent', models.BooleanField(default=False, help_text='Do you want to list/buy/sell property as an Agent?', verbose_name='Agent')),
